...
//Check if fight is scheduled or not, by entering all fields except departure date
//Departure and Arrival Date are required Arrival time should be after the departure
