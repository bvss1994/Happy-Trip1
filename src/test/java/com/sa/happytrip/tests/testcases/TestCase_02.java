...
//Check if fight is scheduled, by entering valid details in all fields but Schedule time is given invalid time
//The flight is already scheduled during the given time. 
//There should be at least 3 hours gap between its last arrival and next departure
